...
tf.app.flags.DEFINE_string('checkpoint_path', '/cache/east_ckpt/', '')
tf.app.flags.DEFINE_string('checkpoint_path_obs', 's3://tcd-public/ckpt', '')
tf.app.flags.DEFINE_boolean('restore', False, 'whether to resotre from checkpoint')
tf.app.flags.DEFINE_integer('save_checkpoint_steps', 1000, '')
tf.app.flags.DEFINE_integer('save_summary_steps', 100, '')
tf.app.flags.DEFINE_string('pretrained_model_path', None, '')
tf.app.flags.DEFINE_string('data_url', 'q', '')
tf.app.flags.DEFINE_string('train_url', 'q', '')
tf.app.flags.DEFINE_integer('num_gpus', 1, '')
tf.app.flags.DEFINE_string('training_data_path_obs', './data/train',
...
mox.file.copy_parallel(FLAGS.training_data_path_obs, FLAGS.training_data_path)
...
def main(argv=None):
    ...
    if FLAGS.geometry == 'RBOX':
        ...
        input_geo_maps = tf.placeholder(tf.float32, shape=[None, None, None, 8],
                                        name='input_geo_maps')
    ...
    global_step = tf.get_variable('global_step', [], initializer=tf.constant_initializer(0),
                                  trainable=False)
    learning_rate = tf.train.exponential_decay(FLAGS.learning_rate, global_step, decay_steps=500,
